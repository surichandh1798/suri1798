...
camera = cv2.VideoCapture("C:/Users/Subha/Downloads/test2.mp4")
...
while True:
    ...
    for c in cnts:
        ...
        cv2.line(frame, (width , 0), (width, 450), (250, 0, 1), 2) #blue line
        cv2.line(frame, (width - 50, 0), (width - 50, 450), (0, 0, 255), 2)#red line


        rectangleCenterPoint =  (int (x + x + w) /2,(y + y + h) /2)
...
q=textOut
z=u-q
if (z==0): #in this case 0 is assigned for the condition of dataset 
